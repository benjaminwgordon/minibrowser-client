...
const PostDetail = (props: IPostProps) => {
  ...
  return (
    <div
      className="absolute top-0 left-0 z-10 w-screen h-screen backdrop-blur-sm backdrop-brightness-50 flex items-center justify-center"
      onClick={() => props.close()}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-row h-full">
          ...
          <div className="flex flex-col justify-between items-left w-1/3">
            <a
